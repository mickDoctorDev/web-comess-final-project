...
import { Wrench, Package, MessageCircle, LogOut, Shield } from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col relative text-gray-800">
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto p-6 md:p-12 flex flex-col">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-3xl mx-auto">
          {/* Card 1: แจ้งซ่อม */}
          <Link href="#" className="group bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-blue-200 transition-all flex flex-col items-center text-center">
          ...
          {/* Card 2: รายการสินค้า */}
          <Link href="#" className="group bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-green-200 transition-all flex flex-col items-center text-center">
